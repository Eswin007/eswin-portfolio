    ...
    <div className="directory-case-study max-width-wrap">
      ...
      <section>
        ...
        <p>
          ...
          members stay connected by providing an organized, searchable directory
          of families and individuals. The project was initiated to modernize
          the traditional paper-based directory and offer a more interactive,
      ...
      <section>
        ...
        <p>
          ...
          maintaining and accessing updated member information. Although we had
          published a printed directory, but it was always in the wrong place at
          the wrong time—either gathering dust at home or playing hide and seek
          when needed. So, I decided to create a digital directory that allows
          members and office bearers to quickly search for families, view member
          details, and update information on the go. Plus, let’s be real—I
          wanted to do something more useful than yet another to-do list project
          while levelling up my React.js skills.
        </p>
        <img src="" alt="" />
      </section>
      ...
      <section>
        ...
        <p>
          ...
          instead of an <code>{`[array of objects]`}</code>. Not exactly what I
          needed.
        </p>
        <p>
          ...
          structured data storage and retrieval, improving performance and ease
          of access.
        </p>
        <img src="" alt="" />
      </section>
      ...
      <section>
        ...
        <p>
          ...
          hesitated to create two separate tables. Eventually, I realized that
          splitting the data was the only viable solution. I created a table for
          the main family data and another for family members, linking them via
          a foreign key and enabling the cascade option. The frontend was then
          responsible for joining the data, matching and filtering IDs to create
          structured objects. The same logic was applied when submitting
          data—ensuring that entries were properly assigned to both tables based
          on the form submission criteria.
        </p>
        <img src="" alt="" />
      </section>
      ...
      <section>
        ...
        <p>
          ...
          the information easily accessible at any time. The feedback from users
          was overwhelmingly positive, with many appreciating the simplicity and
          efficiency of the directory. The project also provided me with
          valuable hands-on experience in React development, database
      ...
      <section>
        ...
        <p>
          This project strengthened my skills in React, database management, and
          UI/UX design. I learned how to handle real-world data structures,
          implement efficient filtering techniques, and optimize frontend
          performance.
        </p>
        <p>For future improvements, I would like to: </p>
        <ul>
          <li>
            Implement user authentication to restrict access to authorized
            members.
          </li>
          <li>
            Introduce role-based permissions, allowing different levels of
      ...
      <section>
        ...
        <p>
          My primary objective when creating this project was to gain experience
          in React, but what started as a technical challenge evolved into a
          meaningful contribution to the church community. While refining my
          skills in UX and React, this project reinforced my problem-solving
          abilities and adaptability to new technologies.
        </p>
